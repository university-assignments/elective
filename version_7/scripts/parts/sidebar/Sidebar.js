...
export class Sidebar extends PartConstructor
{
	async initialize ()
	{
		this.template_sidebar    = await FilesTools.getText('./scripts/parts/sidebar/sidebar.mst.html');
		this.template_navigation = await FilesTools.getText('./scripts/parts/sidebar/navigation.mst.html');
